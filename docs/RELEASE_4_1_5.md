...
- Active standalone lessons and challenges keep the question and Previous/Next navigation in focus. The catalogue controls return when the user goes back to the list. On phones, Activity and Beam jumps let the student move between the task and aligned diagrams without hiding the other view.
