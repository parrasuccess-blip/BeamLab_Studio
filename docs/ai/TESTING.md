...
## 4.1.5 workspace and explanation release — 2026-09-24

Final feature `eeb5986` CI 35993030160: **1,297** numerical/behaviour checks and **152/152** desktop Chromium/Firefox, iPhone WebKit and 360 px Chromium browser checks passed, zero retries. Merged-main 35994312495 also passed both regression and browser. New assertions keep Learn optional, focused lesson navigation with direct Mastery, original beam restoration and a Build heading that clears the sticky header. The pre-existing physical Undo hit-target, numerical tolerances and failure checks remain intact. Public verification 35996051228 downloads the actual production HTML and release metadata: version **4.1.5**, byte-identical SHA-256 `6953a87b94c53bf17043c765f6388d32364c795f23ff8272e1abfb8a54152171`. Fresh public desktop and 390 px Chromium journeys pass Build → lesson → original model, no heading occlusion/overflow. Screenshot artifact 10806232354. Phone evidence remains emulated.
