...
## Current release — Account A, 2026-09-24

**STATUS: BeamLab Studio 4.1.5 released and verified on the public site.**

- Canonical repository: `parrasuccess-blip/BeamLab_Studio`; production branch: `main`; public URL: https://beam-lab-studio.vercel.app/.
- Released through [PR #25](https://github.com/parrasuccess-blip/BeamLab_Studio/pull/25), merge commit `977568b84d641a5a14084e57b26fcf83b4ecbcd9`; validated feature head `eeb598609a65a32e9b633c9c7e943ef3e418f064`. The verification branch `docs/verify-4-1-5-production` and [PR #26](https://github.com/parrasuccess-blip/BeamLab_Studio/pull/26) record the public checks. Production HTML is independent of that documentation branch.
- Exact feature [CI 35993030160](https://github.com/parrasuccess-blip/BeamLab_Studio/actions/runs/35993030160): **1,297 numerical/behaviour checks, 152/152 browser journeys**, zero retries. Merged-main [CI 35994312495](https://github.com/parrasuccess-blip/BeamLab_Studio/actions/runs/35994312495) also has green regression and browser jobs. No numerical solver, tolerances or signs changed.
- [Live public verification 35996051228](https://github.com/parrasuccess-blip/BeamLab_Studio/actions/runs/35996051228) fetched the public HTML, SHA256.txt and release.json directly: all identify **4.1.5** and SHA-256 `6953a87b94c53bf17043c765f6388d32364c795f23ff8272e1abfb8a54152171`, byte-identical to the validated build. Fresh live desktop and 390 px Chromium phone journeys passed Build → lesson → original beam, title clearance beneath the header and no horizontal overflow. Screenshots: [public evidence artifact](https://github.com/parrasuccess-blip/BeamLab_Studio/actions/runs/35996051228/artifacts/10806232354). These phone checks are emulated, not physical device testing.
- 4.1.5 grouped the direct engineering path, kept Learn optional with clearer focused navigation, improved formula typography and made Show Why explain three steps from the deterministic solved model. Build/Analyse/Review results stay available outside active learning activities, and leaving a standalone lesson restores the actual beam, Undo/Redo and comparison. Design criteria remain user-entered screening only, with no code-certification claim.
- Start the next update from the **current main**, inspect PRs and this handoff first. Follow crash-safe feature branch, draft PR, source checkpoint and validation gates. Planned follow-up can further refine lesson information density and gather physical-device feedback; the release itself is complete.

## Prior 4.1.4 state — Account A, 2026-09-24
