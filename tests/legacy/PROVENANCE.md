...
Adaptations: source and artifact paths now match this repository; expected release identity is 4.1.2 / BL410; the unloaded finite-field check names every numeric sample field, because stepped-section samples also carry string/null metadata. No numerical assertion or supported case was removed.
